...
/**
 * @brief Saves an image onto the SD card
 *
 * @param imageData Pointer to the pixel data to write
 * @param imageLength The number of bytes the pixel data contains
 * @param Datetime The datetime that the image was taken
 * @param temperature The temperature the image was taken at
 * @param returnMsg Pointer to a string for error message if an error occurs
 * @return uint8_t TRUE if sucessful else FALSE
 */
