...
//     struct sp_port* port;
//     sp_return error = sp_get_port_by_name("COM12", &port);
//     if (error != SP_OK) {
//         printf("COM12 could not be opened\r\n");
//         return 1;
//     }
...
//     if (error != SP_OK) {
//         printf("The COM port could not be configured\r\n");
//         return 1;
//         // Handle error
//     }
...
//     if (error != SP_OK) {
//         printf("The COM port could not be configured for read write\r\n");
//         return 1;
//         // Handle error
//     }

//     uint8_t buffer[1024];
//     ssize_t bytes_read = sp_blocking_read(port, buffer, sizeof(buffer), 100);
//     if (bytes_read < 0) {
//         // Handle error
//     } else {
...
//     ssize_t bytes_written = sp_blocking_write(port, data, sizeof(data), 100);
//     if (bytes_written < 0) {
//         // Handle error
//     }
